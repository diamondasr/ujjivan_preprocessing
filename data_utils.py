...
utt2spk_filepath,transcription_filepath,wav_list_file,wav_scp_path,language_code):
    ...
    try:
        ...
        append_row_file(spk2utt_filepath, str(speaker_id) + "_" +   utterance_id   + " " + utterance_id )
        append_row_file(utt2spk_filepath, utterance_id + " "  + str(speaker_id) + "_" +   utterance_id  )
